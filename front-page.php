...
?>  
  ...
  <section>
    <div class="container flex flex-wrap items-start justify-between mx-auto my-16">
      <?php
      ...
      ?>
        <a
          ...
          class="flex-col items-center w-full sm:w-1/5 mb-10 sm:mb-0"
        >
  ...
  <?php if ( have_rows( 'rpt_mvv', get_option('page_on_front') ) ) : ?>
    <section class="my-20">
      <div class="container mx-auto flex flex-wrap items-stretch">
        ...
        ?>
          <div class="flex items-start justify-between w-full sm:w-1/3 p-5 <?php echo $bg; ?>">
